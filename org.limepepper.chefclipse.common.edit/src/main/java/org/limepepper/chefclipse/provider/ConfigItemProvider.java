...
/**
 * This is the item provider adapter for a {@link org.limepepper.chefclipse.Config} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChefclipsePackage.Literals.CONFIG__CHEF_SERVER_URL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChefclipsePackage.Literals.CONFIG__CLIENT_KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChefclipsePackage.Literals.CONFIG__NODE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChefclipsePackage.Literals.CONFIG__LOG_LEVEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChefclipsePackage.Literals.CONFIG__VALIDATION_KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChefclipsePackage.Literals.CONFIG__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChefclipsePackage.Literals.CONFIG__VALIDATION_CLIENT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Config.class)) {
			case ChefclipsePackage.CONFIG__CHEF_SERVER_URL:
			case ChefclipsePackage.CONFIG__CLIENT_KEY:
			case ChefclipsePackage.CONFIG__NODE_NAME:
			case ChefclipsePackage.CONFIG__LOG_LEVEL:
			case ChefclipsePackage.CONFIG__VALIDATION_KEY:
			case ChefclipsePackage.CONFIG__VERSION:
			case ChefclipsePackage.CONFIG__VALIDATION_CLIENT_NAME:

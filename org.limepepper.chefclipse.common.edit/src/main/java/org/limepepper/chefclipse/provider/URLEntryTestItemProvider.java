...
/**
 * This is the item provider adapter for a {@link org.limepepper.chefclipse.URLEntryTest} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class URLEntryTestItemProvider
	 ...
	 * @generated
	 */
	public URLEntryTestItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChefclipsePackage.Literals.URL_ENTRY_TEST__URL,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(URLEntryTest.class)) {
			case ChefclipsePackage.URL_ENTRY_TEST__URL:

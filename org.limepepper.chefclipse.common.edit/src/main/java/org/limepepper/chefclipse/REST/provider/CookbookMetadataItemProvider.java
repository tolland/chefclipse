...
public class CookbookMetadataItemProvider
	...
	protected void addLicensePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CookbookMetadata_license_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CookbookMetadata_license_feature", "_UI_CookbookMetadata_type"),
				 RESTPackage.Literals.COOKBOOK_METADATA__LICENSE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addReplacingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CookbookMetadata_replacing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CookbookMetadata_replacing_feature", "_UI_CookbookMetadata_type"),
				 RESTPackage.Literals.COOKBOOK_METADATA__REPLACING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CookbookMetadata_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CookbookMetadata_description_feature", "_UI_CookbookMetadata_type"),
				 RESTPackage.Literals.COOKBOOK_METADATA__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CookbookMetadata.class)) {
			...
			case RESTPackage.COOKBOOK_METADATA__LICENSE:
			case RESTPackage.COOKBOOK_METADATA__REPLACING:
			case RESTPackage.COOKBOOK_METADATA__DESCRIPTION:

...
/**
 * This is the item provider adapter for a {@link org.limepepper.chefclipse.REST.CookbookListResp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CookbookListRespItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RESTPackage.Literals.COOKBOOK_LIST_RESP__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RESTPackage.Literals.COOKBOOK_LIST_RESP__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RESTPackage.Literals.COOKBOOK_LIST_RESP__VERSIONS);
		}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CookbookListResp.class)) {
			case RESTPackage.COOKBOOK_LIST_RESP__NAME:
			case RESTPackage.COOKBOOK_LIST_RESP__URL:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case RESTPackage.COOKBOOK_LIST_RESP__VERSIONS:
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RESTPackage.Literals.COOKBOOK_LIST_RESP__VERSIONS,
				 RESTFactory.eINSTANCE.createCookbookListVersionResp()));
	}

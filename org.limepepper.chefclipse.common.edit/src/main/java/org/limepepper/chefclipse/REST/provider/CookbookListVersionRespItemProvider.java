...
/**
 * This is the item provider adapter for a {@link org.limepepper.chefclipse.REST.CookbookListVersionResp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CookbookListVersionRespItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RESTPackage.Literals.COOKBOOK_LIST_VERSION_RESP__URL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RESTPackage.Literals.COOKBOOK_LIST_VERSION_RESP__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CookbookListVersionResp.class)) {
			case RESTPackage.COOKBOOK_LIST_VERSION_RESP__URL:
			case RESTPackage.COOKBOOK_LIST_VERSION_RESP__VERSION:

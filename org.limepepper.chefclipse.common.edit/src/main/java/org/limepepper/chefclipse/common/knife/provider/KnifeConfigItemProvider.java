 ...
 * @generated
 */
public class KnifeConfigItemProvider extends ConfigItemProvider implements
	...
	protected void addCache_typePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_cache_type_feature",
						"_UI_KnifeConfig_type"),
				KnifePackage.Literals.KNIFE_CONFIG__CACHE_TYPE, true, false,
	...
	protected void addCache_optionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_cache_option_feature",
						"_UI_KnifeConfig_type"),
				KnifePackage.Literals.KNIFE_CONFIG__CACHE_OPTION, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addCookbook_pathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_cookbook_path_feature",
						"_UI_KnifeConfig_type"),
				KnifePackage.Literals.KNIFE_CONFIG__COOKBOOK_PATH, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addCookbook_copyrightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_cookbook_copyright_feature",
						"_UI_KnifeConfig_type"),
	...
	protected void addCookbook_emailPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_cookbook_email_feature",
						"_UI_KnifeConfig_type"),
	...
	protected void addCookbook_licensePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_cookbook_license_feature",
						"_UI_KnifeConfig_type"),
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_KnifeConfig_path_feature",
								"_UI_KnifeConfig_type"),
						KnifePackage.Literals.KNIFE_CONFIG__PATH, true, false,
	...
	protected void addServerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_server_feature",
						"_UI_KnifeConfig_type"),
				KnifePackage.Literals.KNIFE_CONFIG__SERVER, false, false, true,
				null, null, null));
	}
	...
	protected void addServerCookbookVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_serverCookbookVersion_feature",
						"_UI_KnifeConfig_type"),
	...
	protected void addRepositoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_KnifeConfig_repository_feature",
						"_UI_KnifeConfig_type"),
				KnifePackage.Literals.KNIFE_CONFIG__REPOSITORY, true, false,
				true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(KnifePackage.Literals.KNIFE_CONFIG__SERVER_COOKBOOK_VERSION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/KnifeConfig"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_KnifeConfig_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case KnifePackage.KNIFE_CONFIG__SERVER:
			fireNotifyChanged(new ViewerNotification(notification,

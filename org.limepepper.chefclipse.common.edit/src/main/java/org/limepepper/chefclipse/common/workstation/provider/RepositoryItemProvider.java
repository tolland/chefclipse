		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Repository_cookbookFolders_feature", "_UI_Repository_type"),
				 WorkstationPackage.Literals.REPOSITORY__COOKBOOK_FOLDERS,
				 true,
				 false,
				 true,
				 null,

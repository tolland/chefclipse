 ...
 * @generated
 */
public class ServerItemProvider extends ItemProviderAdapter implements
	...
	protected void addCookbooksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Server_cookbooks_feature", "_UI_Server_type"),
				ChefserverPackage.Literals.SERVER__COOKBOOKS, true, false,
				true, null, null, null));
	}
	...
	protected void addClientsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Server_clients_feature", "_UI_Server_type"),
				ChefserverPackage.Literals.SERVER__CLIENTS, true, false, true,
				null, null, null));
	}
	...
	protected void addWebuiportPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_Server_webuiport_feature",
								"_UI_Server_type"),
						ChefserverPackage.Literals.SERVER__WEBUIPORT, true,
						false, false,
	...
	protected void addSandboxesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Server_sandboxes_feature", "_UI_Server_type"),
				ChefserverPackage.Literals.SERVER__SANDBOXES, true, false,
				true, null, null, null));
	}
	...
	protected void addConfigPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Server_config_feature", "_UI_Server_type"),
				ChefserverPackage.Literals.SERVER__CONFIG, true, false, true,
				null, null, null));
	}
	...
	protected void addKnifeConfigPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Server_knifeConfig_feature", "_UI_Server_type"),
				ChefserverPackage.Literals.SERVER__KNIFE_CONFIG, true, false,
				true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ChefserverPackage.Literals.SERVER__ENVIRONMENTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Server"));
	}

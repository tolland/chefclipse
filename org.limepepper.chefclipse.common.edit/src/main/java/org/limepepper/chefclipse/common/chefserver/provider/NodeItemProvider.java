 ...
 * @generated
 */
public class NodeItemProvider extends DescribedObjectItemProvider implements
	...
	protected void addClientPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Node_client_feature", "_UI_Node_type"),
				ChefserverPackage.Literals.NODE__CLIENT, true, false, true,
				null, null, null));
	}
	...
	protected void addAttributesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Node_attributes_feature", "_UI_Node_type"),
				ChefserverPackage.Literals.NODE__ATTRIBUTES, true, false, true,
				null, null, null));
	}

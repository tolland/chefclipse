...
/**
 * This is the item provider adapter for a {@link org.limepepper.chefclipse.common.chefclient.Client} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClientItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Client_server_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Client_server_feature", "_UI_Client_type"),
				 ChefclientPackage.Literals.CLIENT__SERVER,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Client_type");
	}

 ...
 * @generated
 */
public class ClientConfigItemProvider extends ConfigItemProvider implements
	 ...
	 * @generated
	 */
	public ClientConfigItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ClientConfig"));
	}
	...
	public String getText(Object object) {
		String label = ((ClientConfig) object).getNode_name();
		return label == null || label.length() == 0 ? getString("_UI_ClientConfig_type")
				: getString("_UI_ClientConfig_type") + " " + label;
	}

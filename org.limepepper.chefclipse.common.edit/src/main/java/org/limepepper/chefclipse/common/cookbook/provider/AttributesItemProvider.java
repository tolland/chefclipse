...
/**
 * This is the item provider adapter for a {@link org.limepepper.chefclipse.common.cookbook.Attributes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributesItemProvider
    ...
    public String getText(Object object) {
		String label = ((Attributes)object).getName();
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Attributes.class)) {
			case CookbookPackage.ATTRIBUTES__NAME:
			case CookbookPackage.ATTRIBUTES__ID:
			case CookbookPackage.ATTRIBUTES__CHECKSUM:
			case CookbookPackage.ATTRIBUTES__PATH:
			case CookbookPackage.ATTRIBUTES__SPECIFICITY:
			case CookbookPackage.ATTRIBUTES__BYTES:

 ...
 * @generated
 */
public class DataBagItemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DataBagItem_dataBag_feature", "_UI_DataBagItem_type"),
				 ChefserverPackage.Literals.DATA_BAG_ITEM__DATA_BAG,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataBagItem"));
	}

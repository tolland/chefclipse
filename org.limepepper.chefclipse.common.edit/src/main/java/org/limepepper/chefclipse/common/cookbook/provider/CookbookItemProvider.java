...
public class CookbookItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Cookbook_depends_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Cookbook_depends_feature", "_UI_Cookbook_type"),
                 CookbookPackage.Literals.COOKBOOK__DEPENDS,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Cookbook_name_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Cookbook_name_feature", "_UI_Cookbook_type"),
                 CookbookPackage.Literals.COOKBOOK__NAME,
                 true,
                 false,
                 false,
    ...
    protected void addRepositoryPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Cookbook_repository_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Cookbook_repository_feature", "_UI_Cookbook_type"),
                 CookbookPackage.Literals.COOKBOOK__REPOSITORY,
                 true,
                 false,
                 true,
                 null,
    ...
    public String getText(Object object) {
        String label = ((Cookbook)object).getName();

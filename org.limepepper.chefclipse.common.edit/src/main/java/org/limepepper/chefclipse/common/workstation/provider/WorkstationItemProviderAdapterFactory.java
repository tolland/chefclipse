 ...
 * @generated
 */
public class WorkstationItemProviderAdapterFactory extends
		WorkstationAdapterFactory implements ComposeableAdapterFactory,
	...
	public Adapter createCertificatesFolderAdapter() {
		if (certificatesFolderItemProvider == null) {
			certificatesFolderItemProvider = new CertificatesFolderItemProvider(
					this);
		}
	...
	public Adapter createEnvironmentsFolderAdapter() {
		if (environmentsFolderItemProvider == null) {
			environmentsFolderItemProvider = new EnvironmentsFolderItemProvider(
					this);
		}
	...
	public Adapter createWorkstationFolderAdapter() {
		if (workstationFolderItemProvider == null) {
			workstationFolderItemProvider = new WorkstationFolderItemProvider(
					this);
		}
	...
	public void dispose() {
		...
		if (configFolderItemProvider != null)
			configFolderItemProvider.dispose();
		if (certificatesFolderItemProvider != null)
			certificatesFolderItemProvider.dispose();
		if (dataBagsFolderItemProvider != null)
			dataBagsFolderItemProvider.dispose();
		if (environmentsFolderItemProvider != null)
			environmentsFolderItemProvider.dispose();
		if (rolesFolderItemProvider != null)
			rolesFolderItemProvider.dispose();
		if (rakefileItemProvider != null)
			rakefileItemProvider.dispose();
		if (workstationFolderItemProvider != null)
			workstationFolderItemProvider.dispose();
		if (cookbooksFolderItemProvider != null)
			cookbooksFolderItemProvider.dispose();
	}

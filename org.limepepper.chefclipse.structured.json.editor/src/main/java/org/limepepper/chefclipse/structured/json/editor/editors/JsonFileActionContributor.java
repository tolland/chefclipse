 ...
 */
public class JsonFileActionContributor extends
    ...
    /**
     * This is the action used to remove an existing JSON file.
     */
    protected RemoveJsonFileAction removeJsonFileAction;

    /**
     * This is the action used to add a new JSON file.
     */
    protected AddNewJsonFileAction addNewJsonFileAction;
    ...
    private MultiPageStructuredJsonEditor multiPageEditor;

    public JsonFileActionContributor() {
        super();
        init();
    }

    public JsonFileActionContributor(MultiPageStructuredJsonEditor multiPageStructuredJsonEditor) {
        super();
        this.multiPageEditor = multiPageStructuredJsonEditor;
        init();
    }
    ...
    private void init() {
        ...
        MultiPageStructuredJsonEditor editor = multiPageEditor;

        removeJsonFileAction = (RemoveJsonFileAction) editor.getActionRegistry().get(
                RemoveJsonFileAction.ID);
        removeJsonFileAction.setEnabled(false);
        removeJsonPropertyAction = (RemoveJsonPropertyAction) editor.getActionRegistry().get(
                RemoveJsonPropertyAction.ID);
        addNewJsonFileAction = (AddNewJsonFileAction) editor.getActionRegistry().get(
                AddNewJsonFileAction.ID);
    ...
    public void addJsonFilesRelatedActions(IToolBarManager manager) {
        manager.add(undoAction);
        manager.add(redoAction);
        manager.add(addNewJsonFileAction);
        manager.add(removeJsonFileAction);
    }
    ...
    public void deactivate() {
        ...
        removeJsonFileAction.setActiveWorkbenchPart(null);
        addNewJsonFileAction.setActiveWorkbenchPart(null);
        ...
        if (selectionProvider != null) {
            ...
            selectionProvider.removeSelectionChangedListener(removeJsonFileAction);
            selectionProvider.removeSelectionChangedListener(addJsonPropertyAction);
            selectionProvider.removeSelectionChangedListener(addNewJsonFileAction);
        }
    }
    ...
    public void activate() {
        ...
        removeJsonFileAction.setActiveWorkbenchPart(activeEditorPart);
        addNewJsonFileAction.setActiveWorkbenchPart(activeEditorPart);
        ...
        if (selectionProvider != null) {
            selectionProvider.addSelectionChangedListener(removeJsonFileAction);
            selectionProvider.addSelectionChangedListener(addNewJsonFileAction);
    ...
    public void update() {
        ...
        if (selectionProvider != null) {
            ...
            if (removeJsonFileAction.isEnabled()) {
                removeJsonFileAction.updateSelection(structuredSelection);
            }
            addNewJsonFileAction.updateSelection(structuredSelection);
...
//        menuManager.add(new Separator("edit"));
        ...
        menuManager.add(addNewJsonFileAction);
        menuManager.add(removeJsonFileAction);

...
/**
 * Provides the value and image for a JSON file.
 * 
 * @author Sebastian Sampaoli
 */
public class JsonFileLabelProvider extends StyledCellLabelProvider implements IColorProvider {

    private Resource resource;
	private AdapterFactoryLabelProvider adapterProvider;
	private JsonItemProviderAdapterFactory adapterFactory;

	public JsonFileLabelProvider(Resource resource) {
...
//                    textStyle.font = getFont(element);
    ...
    private String getText(EObject entryElement, int columnIndex, final ViewerCell cell) {
    	...
    	EObject value = StructuredJsonEditorManager.INSTANCE.getEObjectOfKey(entryElement, resource);

 ...
 */
public class DatabagEditorActivator extends AbstractUIPlugin {
    ...
    // The shared instance
    private static DatabagEditorActivator plugin;

    /**
     * The constructor
     */
    public DatabagEditorActivator() {
    }
     ...
     */
    public static DatabagEditorActivator getDefault() {
        return plugin;
    }

...
public class ChefServerApiImpl implements ChefServerApi {
	...
	*/
	...
	@Override
	public CookbookFile getCookbookFile(String name) {

		return getCookbookFile(name, "_latest");
	}

	@Override
	public CookbookFile getCookbookFile(String name, String version) {
		// TODO Auto-generated method stub
		// https://s3-external-1.amazonaws.com/opscode-platform-production-data/organization-ba6155dbe8a54a49b4ee136f1127e5a9/checksum-4c9140a6eda1e63ffe00ab409c1864f7?AWSAccessKeyId=AKIAIN4GUX4PULV7JQSA&Expires=1365783540&Signature=n1YJE3JFw%2B7DcXl5XQNnXjczjEM%3D
		return null;
	}

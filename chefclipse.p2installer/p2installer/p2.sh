...
ECLIPSE_BASE=%{USER_HOME}/opt/p2installer
...
mkdir -p %{USER_HOME}/opt/chefclipse

./director \
	-data /home/tomhodder/workspace-chefclipse \
	-consolelog -clean \
	-repository https://github.com/limepepper/p2/raw/master/chefclipse/tomhodder/update-site \
	...
	-tag InitialState \
	-destination %{USER_HOME}/opt/chefclipse \
	-profile chefclipse \
	-p2.os linux \
	-p2.ws gtk \
	-p2.arch %{os_arch} \
	...
	-vmargs \
	-Declipse.p2.data.area=%{USER_HOME}/opt/chefclipse/p2 \
	-Xms128M \
	-Xmx256M \
	-XX:PermSize=128M \
	-XX:MaxPermSize=256M 

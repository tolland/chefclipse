...
import org.limepepper.chefclipse.common.knife.util.KnifeResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>knife</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class KnifeExample {
	/**
	 * <!-- begin-user-doc -->
...
<<<<<<< HEAD
		...
		resourceSet
				...
				.put(Resource.Factory.Registry.DEFAULT_EXTENSION,
						new KnifeResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put(KnifePackage.eNS_URI,
				KnifePackage.eINSTANCE);

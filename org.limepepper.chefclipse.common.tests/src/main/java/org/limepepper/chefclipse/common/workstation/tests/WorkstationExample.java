...
import org.limepepper.chefclipse.common.workstation.util.WorkstationResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>workstation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
...
<<<<<<< HEAD
		...
		//
		resourceSet.getPackageRegistry().put(WorkstationPackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.workstation"));
				Repository root = WorkstationFactory.eINSTANCE
						.createRepository();

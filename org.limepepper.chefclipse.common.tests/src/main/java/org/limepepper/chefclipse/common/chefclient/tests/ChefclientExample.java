...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>chefclient</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ChefclientExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet
				...
				.put(Resource.Factory.Registry.DEFAULT_EXTENSION,
						new ChefclientResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put(ChefclientPackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.chefclient"));
				ChefClient root = ChefclientFactory.eINSTANCE
						.createChefClient();

...
public class RESTPackageImpl extends EPackageImpl implements RESTPackage {
	 ...
	 * @generated
	 */
	public EAttribute getCookbookMetadata_License() {
		return (EAttribute)cookbookMetadataEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCookbookMetadata_Replacing() {
		return (EAttribute)cookbookMetadataEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCookbookMetadata_Description() {
		return (EAttribute)cookbookMetadataEClass.getEStructuralFeatures().get(6);
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(cookbookMetadataEClass, COOKBOOK_METADATA__LICENSE);
		createEAttribute(cookbookMetadataEClass, COOKBOOK_METADATA__REPLACING);
		createEAttribute(cookbookMetadataEClass, COOKBOOK_METADATA__DESCRIPTION);
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getCookbookMetadata_License(), ecorePackage.getEString(), "license", "", 1, 1, CookbookMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCookbookMetadata_Replacing(), ecorePackage.getEString(), "replacing", null, 1, 1, CookbookMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCookbookMetadata_Description(), ecorePackage.getEString(), "description", null, 1, 1, CookbookMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

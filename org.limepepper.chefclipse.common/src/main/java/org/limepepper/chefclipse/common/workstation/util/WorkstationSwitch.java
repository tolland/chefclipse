...
public class WorkstationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case WorkstationPackage.REPOSITORY: {
			...
			if (result == null)
				result = caseNamedDescribedObject(repository);
			if (result == null)
				result = caseDescribedObject(repository);
			if (result == null)
				result = caseNamedObject(repository);
			if (result == null)
		...
		case WorkstationPackage.CONFIG_FOLDER: {
			...
			if (result == null)
				result = caseWorkstationFolder(configFolder);
			if (result == null)
				result = caseNamedObject(configFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WorkstationPackage.CERTIFICATES_FOLDER: {
			...
			if (result == null)
				result = caseWorkstationFolder(certificatesFolder);
			if (result == null)
				result = caseNamedObject(certificatesFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WorkstationPackage.DATA_BAGS_FOLDER: {
			...
			if (result == null)
				result = caseWorkstationFolder(dataBagsFolder);
			if (result == null)
				result = caseNamedObject(dataBagsFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WorkstationPackage.ENVIRONMENTS_FOLDER: {
			...
			if (result == null)
				result = caseWorkstationFolder(environmentsFolder);
			if (result == null)
				result = caseNamedObject(environmentsFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WorkstationPackage.ROLES_FOLDER: {
			...
			if (result == null)
				result = caseWorkstationFolder(rolesFolder);
			if (result == null)
				result = caseNamedObject(rolesFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case WorkstationPackage.WORKSTATION_FOLDER: {
			...
			if (result == null)
				result = caseNamedObject(workstationFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WorkstationPackage.COOKBOOKS_FOLDER: {
			...
			if (result == null)
				result = caseWorkstationFolder(cookbooksFolder);
			if (result == null)
				result = caseNamedObject(cookbooksFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}

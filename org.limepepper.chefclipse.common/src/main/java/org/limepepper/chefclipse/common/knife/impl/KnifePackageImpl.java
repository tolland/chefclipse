...
public class KnifePackageImpl extends EPackageImpl implements KnifePackage {
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getKnifeConfig_Cookbook_path(), theUtilityPackage.getFile(), "cookbook_path", null, 1, 1, KnifeConfig.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getKnifeConfig_Repository(), theWorkstationPackage.getRepository(), theWorkstationPackage.getRepository_Knives(), "repository", null, 0, 1, KnifeConfig.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

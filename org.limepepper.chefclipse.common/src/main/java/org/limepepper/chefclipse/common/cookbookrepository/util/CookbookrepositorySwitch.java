...
public class CookbookrepositorySwitch<T> extends Switch<T> {
	 ...
	 * @generated
	 */
	protected static CookbookrepositoryPackage modelPackage;
	 ...
	 * @generated
	 */
	public CookbookrepositorySwitch() {
		if (modelPackage == null) {
			modelPackage = CookbookrepositoryPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CookbookrepositoryPackage.REMOTE_REPOSITORY: {
				RemoteRepository remoteRepository = (RemoteRepository)theEObject;
				T result = caseRemoteRepository(remoteRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CookbookrepositoryPackage.REMOTE_COOKBOOK: {
				RemoteCookbook remoteCookbook = (RemoteCookbook)theEObject;
				T result = caseRemoteCookbook(remoteCookbook);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Remote Cookbook</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Remote Cookbook</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRemoteCookbook(RemoteCookbook object) {
		return null;
	}

 ...
 * <ul>
 *   <li>{@link org.limepepper.chefclipse.utility.impl.ConfigImpl#getChef_server_url <em>Chef server url</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.utility.impl.ConfigImpl#getClient_key <em>Client key</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.utility.impl.ConfigImpl#getNode_name <em>Node name</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.utility.impl.ConfigImpl#getLog_level <em>Log level</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.utility.impl.ConfigImpl#getValidation_key <em>Validation key</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.utility.impl.ConfigImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.utility.impl.ConfigImpl#getValidation_client_name <em>Validation client name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConfigImpl extends EObjectImpl implements Config {
	...
	protected EClass eStaticClass() {
		return UtilityPackage.Literals.CONFIG;
	}
	...
	public void setClient_key(File newClient_key) {
		eSet(UtilityPackage.Literals.CONFIG__CLIENT_KEY, newClient_key);
	}
	...
	public void setNode_name(String newNode_name) {
		eSet(UtilityPackage.Literals.CONFIG__NODE_NAME, newNode_name);
	}
	...
	public void setLog_level(String newLog_level) {
		eSet(UtilityPackage.Literals.CONFIG__LOG_LEVEL, newLog_level);
	}
	...
	public void setValidation_key(File newValidation_key) {
		eSet(UtilityPackage.Literals.CONFIG__VALIDATION_KEY, newValidation_key);
	}
	...
	public void setVersion(String newVersion) {
		eSet(UtilityPackage.Literals.CONFIG__VERSION, newVersion);
	}

...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.CHEF_CONTAINER: {
				...
				if (result == null) result = caseChefElement(chefContainer);
			...
			case ModelPackage.CHEF_FILE: {
				...
				if (result == null) result = caseChefElement(chefFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHEF_FOLDER: {
				...
				if (result == null) result = caseChefElement(chefFolder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHEF_OBJECT: {
				...
				if (result == null) result = caseChefElement(chefObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHEF_OBJECT_DEFINITION_FILE: {
				...
				if (result == null) result = caseChefElement(chefObjectDefinitionFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHEF_OBJECT_ELEMENT_FILE: {
				...
				if (result == null) result = caseChefElement(chefObjectElementFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHEF_PROJECT: {
				...
				if (result == null) result = caseChefElement(chefProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHEF_RESOURCE: {
				...
				if (result == null) result = caseChefElement(chefResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHEF_WORKSPACE: {
				...
				if (result == null) result = caseChefElement(chefWorkspace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.CHEF_SERVER: {
				...
				if (result == null) result = caseChefElement(chefServer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.COOKBOOK_FOLDER: {
				...
				if (result == null) result = caseChefElement(cookbookFolder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CHEF_ELEMENT: {
				ChefElement chefElement = (ChefElement)theEObject;
				T result = caseChefElement(chefElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Chef Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Chef Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChefElement(ChefElement object) {
		return null;
	}

...
public class CookbookFolder extends ChefFolder {
	 ...
	 * @ordered
	 */
	protected CookbookVersion cookbookVersion;
	...
	public CookbookVersion getCookbookVersion() {
		if (cookbookVersion != null && cookbookVersion.eIsProxy()) {
			...
			cookbookVersion = (CookbookVersion)eResolveProxy(oldCookbookVersion);
	 ...
	 * @generated
	 */
	public CookbookVersion basicGetCookbookVersion() {
		return cookbookVersion;
	}
	...
	public void setCookbookVersion(CookbookVersion newCookbookVersion) {
		CookbookVersion oldCookbookVersion = cookbookVersion;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.COOKBOOK_FOLDER__COOKBOOK_VERSION:
				setCookbookVersion((CookbookVersion)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ModelPackage.COOKBOOK_FOLDER__COOKBOOK_VERSION:
				setCookbookVersion((CookbookVersion)null);
				return;
		}

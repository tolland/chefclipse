...
public class ModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelSwitch<Adapter> modelSwitch =
		new ModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseChefElement(ChefElement object) {
				return createChefElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.limepepper.chefclipse.model.ChefElement <em>Chef Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createChefElementAdapter() {
		return null;
	}

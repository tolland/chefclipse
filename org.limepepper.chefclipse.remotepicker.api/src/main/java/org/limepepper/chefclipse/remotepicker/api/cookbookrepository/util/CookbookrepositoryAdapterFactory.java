...
public class CookbookrepositoryAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	public CookbookrepositoryAdapterFactory() {
	 ...
	 * @generated
	 */
	protected CookbookrepositorySwitch<Adapter> modelSwitch =
		new CookbookrepositorySwitch<Adapter>() {
			@Override
			public Adapter caseRemoteRepository(RemoteRepository object) {
				return createRemoteRepositoryAdapter();
			}
			@Override
			public Adapter caseRemoteCookbook(RemoteCookbook object) {
				return createRemoteCookbookAdapter();
			}
			@Override
...
} //CookbookrepositoryAdapterFactory

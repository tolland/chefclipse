 ...
 * <ul>
 *   <li>{@link org.limepepper.chefclipse.json.json.impl.ArrayValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayValueImpl extends ValueImpl implements ArrayValue {
	...
	public EList<Value> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<Value>(Value.class, this,
					JsonPackage.ARRAY_VALUE__VALUE);
		}
		return value;
	}

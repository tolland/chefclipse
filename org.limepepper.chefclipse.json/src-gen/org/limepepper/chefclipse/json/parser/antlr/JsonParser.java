...
public class JsonParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.limepepper.chefclipse.json.parser.antlr.internal.InternalJsonParser createParser(XtextTokenStream stream) {
		return new org.limepepper.chefclipse.json.parser.antlr.internal.InternalJsonParser(stream, getGrammarAccess());
	}

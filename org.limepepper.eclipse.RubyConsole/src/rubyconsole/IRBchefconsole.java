...
import org.jruby.internal.runtime.ValueAccessor;
    ...
    public class IRBchefconsole extends JFrame {
        public IRBchefconsole(String title) {
            super(title);
        }

        public static void main(final String[] args) {
            final IRBchefconsole console = new IRBchefconsole("Chefclipse IRB Console");
            ...
            final TextAreaReadline tar = new TextAreaReadline(text, " Welcome to the JRuby Chefclipse IRB Console \n\n");

 ...
 *
 */
public class DataBagValueLabelProvider extends LabelProvider implements ITableLabelProvider {

    private Map<String, JsonNode> dataBagItemsMap;

    public DataBagValueLabelProvider(Map<String, JsonNode> nodesMap) {

...
public class AddNewDataBagItemAction extends CommandActionHandler {
    ...
    public AddNewDataBagItemAction(EditingDomain editingDomain, IFolder parentFolder) {
        ...
        ImageDescriptor descriptor = DatabagEditorActivator.getDefault().getImageRegistry().getDescriptor(DatabagEditorActivator.DATA_BAG_EDITOR);
        ImageDescriptor addImageOverlay = DatabagEditorActivator.getDefault().getImageRegistry().getDescriptor(DatabagEditorActivator.ADD_DATA_BAG_ITEM_OVERLAY);

 ...
 */
public class WizardNewDataBagMainPage extends WizardPage {
     ...
     * 
     */
    public WizardNewDataBagMainPage() {
        super("dataBagMainPage");
    }

    public WizardNewDataBagMainPage(String title, IProject chefProject) {
        super("dataBagMainPage");
        setTitle(title);
    ...
    public WizardNewDataBagMainPage(String title) {
        super("dataBagMainPage");
        setTitle(title);
        setDescription("Create a new Data Bag");
    }

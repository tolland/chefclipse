package org.limepepper.chefclipse.emfjson;
...
public class EmfJsonWrapper {

    ResourceSet                   resourceSet = null;

    private static EmfJsonWrapper instance    = null;

    public static EmfJsonWrapper instance() {
        if (instance == null) {
            instance = new EmfJsonWrapper();
        }

        return instance;
    }

    public EmfJsonWrapper() {

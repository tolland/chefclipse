 ...
 * <ul>
 *   <li>{@link org.limepepper.chefclipse.json.json.impl.JsonObjectValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JsonObjectValueImpl extends ValueImpl implements JsonObjectValue {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetValue(JsonObject newValue,
			NotificationChain msgs) {
		JsonObject oldValue = value;
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, JsonPackage.JSON_OBJECT_VALUE__VALUE,
					oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setValue(JsonObject newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- JsonPackage.JSON_OBJECT_VALUE__VALUE, null,
						msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonPackage.JSON_OBJECT_VALUE__VALUE, newValue, newValue));
	}

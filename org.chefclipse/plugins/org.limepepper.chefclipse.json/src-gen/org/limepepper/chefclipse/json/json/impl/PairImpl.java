 ...
 * <ul>
 *   <li>{@link org.limepepper.chefclipse.json.json.impl.PairImpl#getString <em>String</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.json.json.impl.PairImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public void setString(String newString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonPackage.PAIR__STRING, oldString, string));
	}
	...
	public NotificationChain basicSetValue(Value newValue,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, JsonPackage.PAIR__VALUE, oldValue,
					newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonPackage.PAIR__VALUE, null,
						msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonPackage.PAIR__VALUE, newValue, newValue));
	}

...
public class RunListEditor extends EditorPart {
	...
	public void init(final IEditorSite site, final IEditorInput input)
		...
		KnifeConfig config = runListInput.getKnifeConfig();
		api = configController.getServer(config);

		setInput(runListInput);
	}
	...
	public void createPartControl(final Composite parent) {
		...
		nodeTableviewer
				.addSelectionChangedListener(nodeTableviewer_SelectionChangedListener);

		// Creating the server cookbook section
		Section serverCookbookSection = toolkit.createSection(body,
		...
		serverCookbookTableviewer
				.setContentProvider(new ServerCookbookContentProvider());
		serverCookbookTableviewer
				.setLabelProvider(new ServerCookbookLabelProvider());
		serverCookbookTableviewer.setInput(api.getCookbooks());
		serverCookbookTableviewer
				.addSelectionChangedListener(serverCookbookTableviewer_SelectionChangedListener);

		// Creating the runlist section
		Section runlistSection = toolkit.createSection(body,
				Section.DESCRIPTION | Section.TITLE_BAR);
	...
	ISelectionChangedListener nodeTableviewer_SelectionChangedListener = new ISelectionChangedListener() {
		...
		public void selectionChanged(final SelectionChangedEvent event) {
			...
			if (selection != null) {
				...
				selectedNode = node;
				runlistTableViewer.setInput(selectedNode);
			}
		}
	...
	ISelectionChangedListener serverCookbookTableviewer_SelectionChangedListener = new ISelectionChangedListener() {
		...
		public void selectionChanged(final SelectionChangedEvent event) {
			IStructuredSelection selection = (IStructuredSelection) serverCookbookTableviewer
					.getSelection();
			if (selection != null) {
				ServerCookbookVersion serverCookbook = (ServerCookbookVersion) selection
						.getFirstElement();
	...
	class ServerCookbookContentProvider extends AdapterFactoryContentProvider {
		...
		public Object[] getElements(final Object inputElement) {
			...
			return serverCookbooks
					.toArray(new ServerCookbookVersion[serverCookbooks.size()]);
		}
	}
	...
	class RunListContentProvider extends AdapterFactoryContentProvider {
		...
		public Object[] getElements(final Object inputElement) {
			...
			return runlistItemList.toArray(new RunListItem[runlistItemList
					.size()]);
		}
	}
	...
	class RecipeContentProvider extends AdapterFactoryContentProvider {
		...
		public Object[] getElements(final Object inputElement) {
			...
			return recipeList
					.toArray(new ServerCookbookFile[recipeList.size()]);
		}
	}

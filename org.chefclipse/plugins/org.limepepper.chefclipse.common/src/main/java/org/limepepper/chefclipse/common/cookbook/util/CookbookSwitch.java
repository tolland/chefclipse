...
public class CookbookSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CookbookPackage.COOKBOOK_VERSION: {
			...
			if (result == null)
				result = caseNamedDescribedObject(cookbookVersion);
			if (result == null)
				result = caseCookbook(cookbookVersion);
			if (result == null)
				result = caseDescribedObject(cookbookVersion);
			if (result == null)
				result = caseNamedObject(cookbookVersion);
			if (result == null)
		...
		case CookbookPackage.DEFINITION: {
			...
			if (result == null)
				result = caseCookbookFile(definition);
			if (result == null)
				result = caseNamedObject(definition);
			if (result == null)
				result = caseChecksumFile(definition);
			if (result == null)
				result = caseSandboxedObject(definition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.LIBRARY: {
			...
			if (result == null)
				result = caseCookbookFile(library);
			if (result == null)
				result = caseNamedObject(library);
			if (result == null)
				result = caseChecksumFile(library);
			if (result == null)
				result = caseSandboxedObject(library);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CookbookPackage.RECIPE: {
			...
			if (result == null)
				result = caseCookbookFile(recipe);
			if (result == null)
				result = caseRubyFile(recipe);
			if (result == null)
				result = caseRunListItem(recipe);
			if (result == null)
				result = caseNamedObject(recipe);
			if (result == null)
				result = caseChecksumFile(recipe);
			if (result == null)
				result = caseSandboxedObject(recipe);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.RECIPE_DESCRIPTION: {
			...
			if (result == null)
				result = caseNamedDescribedObject(recipeDescription);
			if (result == null)
				result = caseDescribedObject(recipeDescription);
			if (result == null)
				result = caseNamedObject(recipeDescription);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.RESOURCE: {
			...
			if (result == null)
				result = caseCookbookFile(resource);
			if (result == null)
				result = caseRubyFile(resource);
			if (result == null)
				result = caseNamedObject(resource);
			if (result == null)
				result = caseChecksumFile(resource);
			if (result == null)
				result = caseSandboxedObject(resource);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.TEMPLATE: {
			...
			if (result == null)
				result = caseCookbookFile(template);
			if (result == null)
				result = caseNamedObject(template);
			if (result == null)
				result = caseChecksumFile(template);
			if (result == null)
				result = caseSandboxedObject(template);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.ATTRIBUTES: {
			...
			if (result == null)
				result = caseCookbookFile(attributes);
			if (result == null)
				result = caseRubyFile(attributes);
			if (result == null)
				result = caseNamedObject(attributes);
			if (result == null)
				result = caseChecksumFile(attributes);
			if (result == null)
				result = caseSandboxedObject(attributes);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.FILE: {
			...
			if (result == null)
				result = caseCookbookFile(file);
			if (result == null)
				result = caseNamedObject(file);
			if (result == null)
				result = caseChecksumFile(file);
			if (result == null)
				result = caseSandboxedObject(file);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CookbookPackage.METADATA: {
			...
			if (result == null)
				result = caseCookbookFile(metadata);
			if (result == null)
				result = caseRubyFile(metadata);
			if (result == null)
				result = caseMaintainedObject(metadata);
			if (result == null)
				result = caseNamedDescribedObject(metadata);
			if (result == null)
				result = caseNamedObject(metadata);
			if (result == null)
				result = caseChecksumFile(metadata);
			if (result == null)
				result = caseSandboxedObject(metadata);
			if (result == null)
				result = caseDescribedObject(metadata);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.PROVIDER: {
			...
			if (result == null)
				result = caseCookbookFile(provider);
			if (result == null)
				result = caseNamedObject(provider);
			if (result == null)
				result = caseChecksumFile(provider);
			if (result == null)
				result = caseSandboxedObject(provider);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.ROOT_FILE: {
			...
			if (result == null)
				result = caseCookbookFile(root_file);
			if (result == null)
				result = caseNamedObject(root_file);
			if (result == null)
				result = caseChecksumFile(root_file);
			if (result == null)
				result = caseSandboxedObject(root_file);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.MINIMAL_METADATA: {
			...
			if (result == null)
				result = caseMetadata(minimalMetadata);
			if (result == null)
				result = caseCookbookFile(minimalMetadata);
			if (result == null)
				result = caseRubyFile(minimalMetadata);
			if (result == null)
				result = caseMaintainedObject(minimalMetadata);
			if (result == null)
				result = caseNamedDescribedObject(minimalMetadata);
			if (result == null)
				result = caseNamedObject(minimalMetadata);
			if (result == null)
				result = caseChecksumFile(minimalMetadata);
			if (result == null)
				result = caseSandboxedObject(minimalMetadata);
			if (result == null)
				result = caseDescribedObject(minimalMetadata);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CookbookPackage.COOKBOOK_FILE: {
			...
			if (result == null)
				result = caseNamedObject(cookbookFile);
			if (result == null)
				result = caseChecksumFile(cookbookFile);
			if (result == null)
				result = caseSandboxedObject(cookbookFile);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}

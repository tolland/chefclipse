...
package org.limepepper.chefclipse.application.dynamic.splashHandlers;
...
public class ExtensibleSplashHandler extends AbstractSplashHandler {
	...
	private final static String F_SPLASH_EXTENSION_ID = "org.limepepper.chefclipse.application.dynamic.splashExtension"; //NON-NLS-1

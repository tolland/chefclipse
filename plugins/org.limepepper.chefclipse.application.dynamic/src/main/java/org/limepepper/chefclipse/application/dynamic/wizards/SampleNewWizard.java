package org.limepepper.chefclipse.application.dynamic.wizards;
...
public class SampleNewWizard extends Wizard implements INewWizard {
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "org.limepepper.chefclipse.application.dynamic", IStatus.OK, message, null);

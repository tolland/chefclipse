...
/**
 * This is the item provider adapter for a {@link org.limepepper.chefclipse.workstation.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkstationPackage.Literals.REPOSITORY__CONFIGURATION);
		}
	...
	public String getText(Object object) {
		String label = ((Repository)object).getOS();
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkstationPackage.Literals.REPOSITORY__COOKBOOKS,
				 CookbookFactory.eINSTANCE.createCookbook()));

		newChildDescriptors.add
			(createChildParameter
				(WorkstationPackage.Literals.REPOSITORY__CONFIGURATION,
				 WorkstationFactory.eINSTANCE.createConfig()));
	}

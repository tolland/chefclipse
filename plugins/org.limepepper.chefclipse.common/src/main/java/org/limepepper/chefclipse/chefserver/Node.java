 ...
 * <ul>
 *   <li>{@link org.limepepper.chefclipse.chefserver.Node#getRun_listList <em>Run list</em>}</li>
...
public class Node extends EObjectImpl implements EObject {
	/**
	 * The cached value of the '{@link #getRun_listList() <em>Run list</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRun_listList()
	 * @generated
	...
	/**
	 * The empty value for the '{@link #getRun_list() <em>Run list</em>}' array accessor.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRun_list()
	 * @generated
	 * @ordered
	 */
	protected static final RunList[] RUN_LIST_EEMPTY_ARRAY = new RunList [0];
	...
	public RunList[] getRun_list() {
		if (run_list == null || run_list.isEmpty()) return RUN_LIST_EEMPTY_ARRAY;
		BasicEList<RunList> list = (BasicEList<RunList>)run_list;
		list.shrink();
	 ...
	 * @generated
	 */
	public RunList getRun_list(int index) {
		return getRun_listList().get(index);
	}
	 ...
	 * @generated
	 */
	public int getRun_listLength() {
		return run_list == null ? 0 : run_list.size();
	}
	...
	public void setRun_list(RunList[] newRun_list) {
		((BasicEList<RunList>)getRun_listList()).setData(newRun_list.length, newRun_list);
	}
	 ...
	 * @generated
	 */
	public void setRun_list(int index, RunList element) {
		getRun_listList().set(index, element);
	}
	 ...
	 * @generated
	 */
	public EList<RunList> getRun_listList() {
		if (run_list == null) {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ChefPackage.NODE__RUN_LIST:
				return ((InternalEList<?>)getRun_listList()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ChefPackage.NODE__RUN_LIST:
				getRun_listList().clear();
				getRun_listList().addAll((Collection<? extends RunList>)newValue);
				return;
			case ChefPackage.NODE__ENVIRONMENT:

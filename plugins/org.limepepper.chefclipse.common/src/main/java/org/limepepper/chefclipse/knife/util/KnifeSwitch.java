...
public class KnifeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case KnifePackage.KNIFE_PLUGIN: {
				KnifePlugin knifePlugin = (KnifePlugin)theEObject;
				T result = caseKnifePlugin(knifePlugin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseKnifePlugin(KnifePlugin object) {
		return null;
	}

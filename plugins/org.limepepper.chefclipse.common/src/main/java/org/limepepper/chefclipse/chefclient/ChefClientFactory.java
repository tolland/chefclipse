...
public class ChefClientFactory extends EFactoryImpl {
	...
	public static ChefClientFactory init() {
		try {
			ChefClientFactory theChefClientFactory = (ChefClientFactory)EPackage.Registry.INSTANCE.getEFactory("http://limepepper.org/chefclipse/v0.0.1/chefclipse"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ChefClientPackage.OHAI_PLUGIN: return createOhaiPlugin();
			default:
	 ...
	 * @generated
	 */
	public OhaiPlugin createOhaiPlugin() {
		OhaiPlugin ohaiPlugin = new OhaiPlugin();
		return ohaiPlugin;
	}

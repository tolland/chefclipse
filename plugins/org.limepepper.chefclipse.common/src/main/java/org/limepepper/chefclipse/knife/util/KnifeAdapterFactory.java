/**
 */
package org.limepepper.chefclipse.knife.util;
...
import org.limepepper.chefclipse.knife.*;
...
public class KnifeAdapterFactory extends AdapterFactoryImpl {
	...
	protected KnifeSwitch<Adapter> modelSwitch =
		new KnifeSwitch<Adapter>() {
			...
			@Override
			public Adapter caseKnifePlugin(KnifePlugin object) {
				return createKnifePluginAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.limepepper.chefclipse.knife.KnifeConfig <em>Config</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.limepepper.chefclipse.knife.KnifePlugin <em>Plugin</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createKnifePluginAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.limepepper.chefclipse.knife.KnifeSearch <em>Search</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

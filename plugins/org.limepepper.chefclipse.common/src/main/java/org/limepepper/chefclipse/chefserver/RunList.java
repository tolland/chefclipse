 ...
 * <ul>
 *   <li>{@link org.limepepper.chefclipse.chefserver.RunList#getNode <em>Node</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.chefserver.RunList#getEnvironment <em>Environment</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.chefserver.RunList#getRole <em>Role</em>}</li>
 *   <li>{@link org.limepepper.chefclipse.chefserver.RunList#getRecipesList <em>Recipes</em>}</li>
 * </ul>
 * </p>
 *
...
public class RunList extends EObjectImpl implements EObject {
	...
	protected EClass eStaticClass() {
		return ChefPackage.Literals.RUN_LIST;
	}
	 ...
	 * @see #setNode(Node)
	 * @see org.limepepper.chefclipse.chefserver.ChefPackage#getRunList_Node()
	 * @model
	 * @generated
	 */
	public Node getNode() {
		if (node != null && node.eIsProxy()) {
			...
			if (node != oldNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChefPackage.RUN_LIST__NODE, oldNode, node));
			}
		}
		return node;
	}
	...
	/**
	 * Sets the value of the '{@link org.limepepper.chefclipse.chefserver.RunList#getNode <em>Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setNode(Node newNode) {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChefPackage.RUN_LIST__NODE, oldNode, node));
	}
	 ...
	 * @see org.limepepper.chefclipse.chefserver.ChefPackage#getRunList_Environment()
	 * @model
	 * @generated
	 */
	public Environment getEnvironment() {
		if (environment != null && environment.eIsProxy()) {
			...
			if (environment != oldEnvironment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChefPackage.RUN_LIST__ENVIRONMENT, oldEnvironment, environment));
			}
		}
		return environment;
	}
	...
	/**
	 * Sets the value of the '{@link org.limepepper.chefclipse.chefserver.RunList#getEnvironment <em>Environment</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setEnvironment(Environment newEnvironment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChefPackage.RUN_LIST__ENVIRONMENT, oldEnvironment, environment));
	}
	 ...
	 * @see #setRole(Role)
	 * @see org.limepepper.chefclipse.chefserver.ChefPackage#getRunList_Role()
	 * @model
	 * @generated
	 */
	public Role getRole() {
		if (role != null && role.eIsProxy()) {
			...
			if (role != oldRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChefPackage.RUN_LIST__ROLE, oldRole, role));
			}
		}
		return role;
	}
	...
	/**
	 * Sets the value of the '{@link org.limepepper.chefclipse.chefserver.RunList#getRole <em>Role</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setRole(Role newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChefPackage.RUN_LIST__ROLE, oldRole, role));
	}
	 ...
	 * @see org.limepepper.chefclipse.chefserver.ChefPackage#getRunList_Recipes()
	 * @model
	 * @generated
	 */
	public EList<Recipe> getRecipesList() {
		if (recipes == null) {
			recipes = new EObjectResolvingEList<Recipe>(Recipe.class, this, ChefPackage.RUN_LIST__RECIPES);
		}
		return recipes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChefPackage.RUN_LIST__NODE:
				if (resolve) return getNode();
				return basicGetNode();
			case ChefPackage.RUN_LIST__ENVIRONMENT:
				if (resolve) return getEnvironment();
				return basicGetEnvironment();
			case ChefPackage.RUN_LIST__ROLE:
				if (resolve) return getRole();
				return basicGetRole();
			case ChefPackage.RUN_LIST__RECIPES:

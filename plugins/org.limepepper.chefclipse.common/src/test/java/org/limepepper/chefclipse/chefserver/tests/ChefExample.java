...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>chefserver</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ChefExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.chef"));
				Environment root = ChefFactory.eINSTANCE.createEnvironment();

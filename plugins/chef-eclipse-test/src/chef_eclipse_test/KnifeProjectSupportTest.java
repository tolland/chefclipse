...
public class KnifeProjectSupportTest {
	    ...
	    private void assertProjectDotFileAndStructureAndNatureExist(String projectPath, String name, URI location) throws DocumentException,
	            CoreException {
	        IProject project = org.limepepper.knife.KnifeProjectSupport.createProject(name, location);
	    ...
	    private void assertNatureIn(IProject project) throws CoreException {
	        ...
	        if (!natureIds[0].equals(KnifeProjectNature.NATURE_ID)) {
	    ...
	    private void assertCreateProjectWithBadNameArg(String name) {
	        URI location = null;
	        try {
	            org.limepepper.knife.KnifeProjectSupport.createProject(name, location);

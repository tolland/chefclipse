...
/**
 * This is the action bar contributor for the Chefserver model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChefserverActionBarContributor
	 ...
	 * @generated
	 */
    public ChefserverActionBarContributor() {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("chefserver-settings"));
		toolBarManager.add(new Separator("chefserver-additions"));
	}
    ...
    public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ChefclipseEditorPlugin.INSTANCE.getString("_UI_ChefserverEditor_menu"), "org.limepepper.chefclipse.common.chefserverMenuID");

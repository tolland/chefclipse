...
/**
 * This is the action bar contributor for the Chefclipse model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChefclipseActionBarContributor
	 ...
	 * @generated
	 */
    public ChefclipseActionBarContributor() {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("chefclipse-settings"));
		toolBarManager.add(new Separator("chefclipse-additions"));
	}
    ...
    public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ChefclipseEditorPlugin.INSTANCE.getString("_UI_ChefclipseEditor_menu"), "org.limepepper.chefclipseMenuID");

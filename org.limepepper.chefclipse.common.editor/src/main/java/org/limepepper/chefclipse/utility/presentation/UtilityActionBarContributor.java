...
/**
 * This is the action bar contributor for the Utility model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UtilityActionBarContributor
	 ...
	 * @generated
	 */
	public UtilityActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("utility-settings"));
		toolBarManager.add(new Separator("utility-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ChefclipseEditorPlugin.INSTANCE.getString("_UI_UtilityEditor_menu"), "org.limepepper.chefclipse.utilityMenuID");

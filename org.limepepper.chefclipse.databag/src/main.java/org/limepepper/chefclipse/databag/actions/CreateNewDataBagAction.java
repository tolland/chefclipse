...
import org.limepepper.chefclipse.structured.json.editor.wizards.BasicNewDataBagWizard;

import chefclipse.core.builders.ChefProjectNature;

/**
 * Action to open the Data Bag editor after creating a new {@link DataBag}.
 *
...
public class CreateNewDataBagAction extends Action {
    ...
    private void initAction() {
        setText("Data Bag");
        setImageDescriptor(StructuredJsonEditorActivator.getDefault().getImageRegistry()
